...
**New to occJSDM? Start with [Learning occJSDM with a community whose truth we know](occJSDM-first-lesson.html).** That lesson fits one matching simulated dataset, compares estimates with the known truth, and works through weak true detections, laboratory false positives, strong true detections and field-stage contamination. It also explains how the priors express expectations about good field and laboratory practice.
