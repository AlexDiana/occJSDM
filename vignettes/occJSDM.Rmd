...
- [Lesson 1: Fit the model and compare its answers with truth](occJSDM-first-lesson.md). The main starting point: fit the model, understand occupancy error, and inspect actual examples of weak true detections, strong true detections and false positives.
