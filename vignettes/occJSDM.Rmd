...
occJSDM, the conditional occupancy means that the occupancy probability
is accounting for both the covariates *and* the observed detection data
at each site. The output is a matrix of
...
sites, and $S$ is the number of species.
