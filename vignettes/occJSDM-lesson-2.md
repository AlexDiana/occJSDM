Lesson 2: Spatial landscapes and dispersal (planned)
================
...
approximately 20% of the unique observed locations. One support point
per unique location can be requested. Check sensitivity by increasing
this number and comparing the predicted probabilities and strength of
the spatial field. More support points cannot replace missing field
observations.
