...
The complete experiment has **640 package/model combinations**, before optimisation restarts: 400 ecological comparisons and 240 trait comparisons. The following status is part of the saved results. It prevents an unfinished run from looking like a completed benchmark.
