...
| Lesson N: Compare four JSDMs | Built from the four-package pilot; sjSDM stability resolved on 23 September with a revised weak-penalty selection | Compare the pure JSDM in occJSDM with gllvm, sjSDM and Hmsc using perfectly observed presence/absence, including what two local optima mean. | [occJSDM-lesson-N.Rmd](occJSDM-lesson-N.Rmd) |
