...
**This is an outline, not a completed spatial analysis.** We will add simulations and matching model results after the spatial correction in PR #8 has completed review. [Lesson 0](%60r%20lesson_link(%22occJSDM-lesson-0%22)%60) and [Lesson 1](%60r%20lesson_link(%22occJSDM-first-lesson%22)%60) already use a verified non-spatial example and do not depend on that pending work.
