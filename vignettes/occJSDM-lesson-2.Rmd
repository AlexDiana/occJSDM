...
**This is an outline, not a completed spatial analysis.** We will add simulations and matching model results after the spatial correction in PR #8 has completed review. [Lesson 0](`r lesson_link("occJSDM-lesson-0")`) and [Lesson 1](`r lesson_link("occJSDM-first-lesson")`) already use a verified non-spatial example and do not depend on that pending work.
