...
We will learn occJSDM using a community whose true distribution is known. **Lesson 0 creates and explores the survey. [Lesson 1 fits the model and checks its answers](%60r%20lesson_link(%22occJSDM-first-lesson%22)%60). [Lesson 2 will introduce spatial landscapes and species that differ in dispersal](%60r%20lesson_link(%22occJSDM-lesson-2%22)%60).** Lesson 2 is a plan, pending review of the spatial submodel in PR #8; it does not yet contain fitted results.
