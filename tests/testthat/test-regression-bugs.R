...
test_that("Fixed bugs 26: a fixed seed reproduces a fit", {
  ...
  #
  # RNG regressions intentionally assert numeric equality. The blanket ban in
  ...
  #
  # Sampling now runs serially regardless of requested TBB threads. The
  # cross-thread and full-model regression is in test-rng-safety.R.
